"""Tests for the post-pull syntax guard in ``ettok update``.
...
markers in ``hermes_cli/config.py``; users who ran ``ettok update`` in
...
# release; if a future ``ettok update`` would brick users, this test fails
# in CI first.
# ---------------------------------------------------------------------------
