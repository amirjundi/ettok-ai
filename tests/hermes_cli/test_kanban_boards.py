"""Tests for the multi-board kanban layer (``ettok kanban boards …``).
...
* CLI surface: ``ettok kanban boards list/create/switch/rm``.
...
def _cli(args: list[str], env_extra: dict | None = None) -> subprocess.CompletedProcess:
    """Run ``ettok kanban …`` with PYTHONPATH pinned to the worktree."""
    env = dict(os.environ)
