...
class TestRuntimeFtsRebuild:
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            ("tmux", "new-session", "/opt/hermes-agent/.venv/bin/ettok gateway"),
    ...
    def test_foreign_holder_uninspectable_process_cmdline_fallback(
        ...
        flagged when /proc/<pid>/cmdline identifies it as a Ettok process."""
        db_path = tmp_path / "state.db"
        ...
        # PID 222's cmdline is world-readable and looks like Ettok
