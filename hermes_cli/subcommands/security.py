"""``ettok security`` subcommand parser."""
...
def build_security_parser(subparsers, *, cmd_security: Callable) -> None:
    ...
    security_parser = subparsers.add_parser(
        ...
        description="On-demand vulnerability scan against OSV.dev. Covers the Ettok "
    ...
    audit_parser.add_argument(
        "--skip-venv", action="store_true", help="Skip scanning the Ettok Python venv")
    audit_parser.add_argument(
