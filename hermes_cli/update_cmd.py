...
def _print_update_check_result(behind: int | None, compare_branch: str) -> None:
    ...
    if behind is not None:
        print(f"ℹ Update available: {behind} {'commit' if behind == 1 else 'commits'} behind {compare_branch}.")
    else:
        print(f"ℹ Update available (behind {compare_branch}).")
