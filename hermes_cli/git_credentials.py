"""Non-interactive HTTPS credentials for Ettok's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``ettok plugins install`` with
