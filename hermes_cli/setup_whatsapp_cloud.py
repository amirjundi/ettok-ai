...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        "", "ℹ WhatsApp Business Cloud API Setup", "=" * 50, "",
        "This wizard configures Ettok to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Ettok needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Ettok gateway in another terminal:",
        "         ettok gateway", "",
