"""Durable aggregation and local export for Ettok shared metrics."""
...
class SharedMetricsStore:
    ...
    def _ensure_schema(self) -> None:
        # Serialize first-run creation and upgrades across Ettok processes.
        with self._write(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            ...
            # so a bump would hard-fail an older Ettok (second profile, rollback) sharing
