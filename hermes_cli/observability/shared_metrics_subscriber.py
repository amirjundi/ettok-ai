"""Relay subscriber for the persisted Ettok shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Ettok counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Ettok shared metric: %s", metric_name, exc_info=True
                )
