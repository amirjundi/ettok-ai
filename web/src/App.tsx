...
function SidebarSystemActions({
  ...
  const updateConfirmDescription = useMemo(() => {
    ...
    const cmd = updateConfirmInfo?.update_command ?? "ettok update";
    return (
  ...
  return (
    ...
    <ConfirmDialog
      ...
      description={
        ...
        "This restarts the Ettok gateway process. Connected channels and active sessions will reconnect afterward."
      }
