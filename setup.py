...
Ettok AI (see website/docs/getting-started/platform-support.md). The
...
Ettok package derivation, so only that build may create an artifact.
...
_BLOCK_MESSAGE = (
    ...
    "Ettok is distributed via the shell installer, Docker image, or Nix.\n"
