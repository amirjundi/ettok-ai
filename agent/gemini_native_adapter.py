...
_FREE_TIER_GUIDANCE = (
    ...
    "Ettok typically makes 3-10 API calls per user turn, so the free tier is exhausted in a handful of "
...
_MISSING_KEY_ERROR = (
    ...
    "environment / ~/.hermes/.env (get one at https://aistudio.google.com/app/apikey), or run `ettok setup` to "
...
class GeminiAPIError(Exception):
    """Error shape compatible with Ettok retry/error classification."""
