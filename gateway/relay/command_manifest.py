...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Ettok session"),
        ...
        _cmd("status", "Show Ettok session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Ettok agent"),
        ...
        _cmd("update", "Update Ettok AI to the latest version"),
        _cmd("restart", "Gracefully restart the Ettok gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Ettok session in it",
